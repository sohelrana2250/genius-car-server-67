const paymentGetWay = (productData, tran_id) => {
  const data = {
    ...
    success_url: `https://car-doctors-server-sigma.vercel.app/api/v1/payment/success/${tran_id}`,
    fail_url: `https://car-doctors-server-sigma.vercel.app/api/v1/payment/fail/${tran_id}`,
    cancel_url: "https://car-doctors-server-sigma.vercel.app/api/v1/cancel",
